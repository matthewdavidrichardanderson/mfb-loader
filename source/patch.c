                       ...
                       void *address, u32 length)
{
    ...
    /* Selective alpha-dither suppression needs a persistent runtime hook.
     * The active freestanding apploader stage installs that hook after all
     * sections are loaded; this host-side scanner intentionally does not. */
}
